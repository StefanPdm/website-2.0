    ...
    <main className='relative z-10 mx-auto max-w-4xl px-4 py-48'>
      <header className='mb-10'>
        ...
        <p className='mt-3 text-slate-300 max-w-2xl'>
          Hier erfahren Sie, welche Cookies wir im NLP-Bereich einsetzen, zu welchen Zwecken und wie
          Sie Ihre Einstellungen verwalten koennen.
        </p>
      </header>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          Cookies sind kleine Textdateien, die auf Ihrem Endgeraet gespeichert werden. Sie dienen
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <ul className='list-disc pl-5 space-y-1 text-slate-300'>
          <li>Technisch notwendige Cookies (erforderlich fuer die Grundfunktionen)</li>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          ...
          Grundlage unseres berechtigten Interesses an einer funktionsfaehigen Website gesetzt (Art.
          6 Abs. 1 lit. f DSGVO, § 25 Abs. 2 Nr. 2 TTDSG).
        </p>
      </section>

      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        <h2 className='text-xl font-semibold text-white mb-3'>Einstellungen aendern</h2>
        <p className='text-slate-300'>
          Sie koennen Ihre Einwilligung jederzeit mit Wirkung fuer die Zukunft widerrufen oder
          anpassen. Nutzen Sie hierfuer die Cookie-Einstellungen:
        </p>
        <div className='mt-4'>
          <a
            href='#'
        ...
        <p className='mt-4 text-slate-300'>
          Zudem koennen Sie Cookies ueber die Einstellungen Ihres Browsers loeschen oder blockieren.
        </p>
      </section>
