...
export default function ProgrammeSection() {
  ...
  const dialogRef = useModal<HTMLDivElement>(Boolean(activeModal), () => setActiveModal(null));
      ...
      {activeModal && (
        <div
          ...
          <div
            ref={dialogRef}
            tabIndex={-1}
            className='relative w-full max-w-4xl max-h-[calc(100dvh-5rem)] overflow-y-auto rounded-[32px] border border-white/40 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.85),rgba(255,255,255,0.65))] p-6 text-[#0B1B2B] shadow-[0_30px_100px_rgba(0,0,0,0.25)] backdrop-blur-xl'>
