    ...
    <main className='relative z-10 mx-auto max-w-4xl px-4 py-48'>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          ...
          sicheren und stoerungsfreien Bereitstellung).
        </p>
      </section>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          ...
          Bearbeitung der Anfrage und fuer den Fall von Anschlussfragen verarbeitet (Art. 6 Abs. 1
          lit. b oder f DSGVO). Pflichtangaben sind als solche gekennzeichnet. Die Daten werden
          geloescht, sobald sie fuer die Zwecke ihrer Verarbeitung nicht mehr erforderlich sind.
        </p>
      </section>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          ...
          analysieren. Details zu eingesetzten Cookies, Speicherfristen und Widerrufsmoeglichkeiten
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <ul className='space-y-2 text-slate-300'>
          <li>Art. 6 Abs. 1 lit. b DSGVO – Vertragserfuellung / vorvertragliche Massnahmen</li>
          <li>Art. 6 Abs. 1 lit. f DSGVO – Wahrung berechtigter Interessen</li>
          <li>Art. 6 Abs. 1 lit. a DSGVO – Einwilligung (z. B. fuer optionale Cookies)</li>
        </ul>
      </section>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          ...
          Vertrages zur Auftragsverarbeitung gemaess Art. 28 DSGVO. Eine Drittlandsuebermittlung
          findet nur statt, wenn geeignete Garantien vorliegen (Art. 44 ff. DSGVO).
        </p>
      </section>
      ...
      <section className='rounded-2xl border border-white/15 bg-white/5 p-6 ring-1 ring-white/10 mb-6'>
        ...
        <p className='text-slate-300'>
          Sofern in dieser Erklaerung nicht anders angegeben, loeschen wir personenbezogene Daten
          grundsaetzlich, sobald der Zweck der Verarbeitung entfaellt und keine gesetzlichen
